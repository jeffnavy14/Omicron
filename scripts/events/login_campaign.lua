...
local loginCampaignStart  = { year = 2025, month = 11, day = 1, hour = 17 }
local loginCampaignEnd    = { year = 2026, month = 11, day = 16, hour = 23 }
local loginCampaignRedeem = { year = 2026, month = 11, day = 10, hour = 0 }
