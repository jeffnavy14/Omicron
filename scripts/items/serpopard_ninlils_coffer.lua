...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 15, xi.item.NARMAR_BOOMERANG },
        { 15, xi.item.NEKHEN_RING        },
        { 10, xi.item.CLOUD_HAIRPIN     },
        {  1, xi.item.CLOUD_HAIRPIN_P1  },
        { 59, xi.item.NONE               },
    }

    local loottwo =
    {
        { 80, xi.item.SERPOPARD_NINLILS_BONE },
