...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.ADSILIO_BOOTS    },
        {  1, xi.item.ADSILIO_BOOTS_P1 },
        { 15, xi.item.EMICO_MANTLE     },
        {  5, xi.item.SALIRE_BELT      },
        { 69, xi.item.NONE             },
    }

    local loottwo =
    {
        { 80, xi.item.BOUNDING_BELINDAS_HIDE },
