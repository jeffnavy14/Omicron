...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 15, xi.item.CHARITONI_SLING   },
        { 15, xi.item.CRESTED_TORQUE    },
        { 10, xi.item.DEW_SILK_CAPE     },
        {  1, xi.item.DEW_SILK_CAPE_P1  },
        { 59, xi.item.NONE              },
    }

    local loottwo =
    {
        { 80, xi.item.PRICKLY_PITRIVS_THREAD },
