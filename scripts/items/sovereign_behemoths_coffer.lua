-----------------------------------
-- ID: 6405
-- Item: sovereign_behemoths_coffer
-----------------------------------
...
itemObject.onItemUse = function(target, user, item, action)
    ...
    {
        { 10, xi.item.ANTITAIL },
        {  1, xi.item.ANTITAIL_P1 },
        {  1, xi.item.DEFENDING_RING },
        { 10, xi.item.DOMINANCE_EARRING },
        {  1, xi.item.DOMINANCE_EARRING_P1 },
        { 10, xi.item.LORICATE_TORQUE },
        {  1, xi.item.LORICATE_TORQUE_P1 },
        { 66, xi.item.NONE       },
    }

    local loottwo =
    {
        { 80, xi.item.SOVEREIGN_BEHEMOTHS_HIDE },
