...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.HYGIEIA_CLOGS    },
        {  1, xi.item.HYGIEIA_CLOGS_P1 },
        { 10, xi.item.TRISKA_SCYTHE    },
        {  1, xi.item.TRISKA_SCYTHE_P1 },
        { 78, xi.item.NONE             },
    }

    local loottwo =
    {
        { 80, xi.item.TUFT_OF_CAMAHUETOS_FUR },
