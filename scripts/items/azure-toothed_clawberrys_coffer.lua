-----------------------------------
-- ID: 6384
-- Item: azure-toothed_clawberrys_coffer
-----------------------------------
...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.ASTERIA_MITTS },
        {  1, xi.item.ASTERIA_MITTS_P1 },
        { 10, xi.item.LAMASSU_MITTS },
        {  1, xi.item.LAMASSU_MITTS_P1 },
        { 78, xi.item.NONE       },
    }

    local loottwo =
    {
        { 80, xi.item.AZURE_TOOTHED_CLAWBERRYS_COAT },
