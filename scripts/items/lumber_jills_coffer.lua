...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.GROUNDED_MANTLE    },
        {  1, xi.item.GROUNDED_MANTLE_P1 },
        { 10, xi.item.SANGARIUS         },
        {  1, xi.item.SANGARIUS_P1      },
        { 78, xi.item.NONE               },
    }

    local loottwo =
    {
        { 80, xi.item.VIAL_OF_LUMBER_JILLS_SPITTLE },
