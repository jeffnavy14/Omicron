-----------------------------------
-- ID: 6350
-- Item: sybaritic_samanthas_coffer
-----------------------------------
...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.UNMOVING_COLLAR    },
        {  1, xi.item.UNMOVING_COLLAR_P1 },
        { 10, xi.item.METAMORPH_RING     },
        {  1, xi.item.METAMORPH_RING_P1  },
        { 78, xi.item.NONE               },
    }

    local loottwo =
    {
        { 80, xi.item.SYBARITIC_SAMANTHAS_VINE },
