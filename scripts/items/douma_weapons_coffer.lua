...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.SHOMONJIJOE         },
        {  1, xi.item.SHOMONJIJOE_P1      },
        { 10, xi.item.RIGOROUS_GRIP      },
        {  1, xi.item.RIGOROUS_GRIP_P1   },
        { 78, xi.item.NONE               },
    }

    local loottwo =
    {
        { 80, xi.item.DOUMA_WEAPONS_SHARD },
