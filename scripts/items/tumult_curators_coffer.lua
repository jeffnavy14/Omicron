...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.COMEUPPANCES },
        {  1, xi.item.COMEUPPANCES_P1 },
        { 10, xi.item.CONTEMPLATOR },
        {  1, xi.item.CONTEMPLATOR_P1 },
        { 10, xi.item.TATENASHI_HARAMAKI },
        {  1, xi.item.TATENASHI_HARAMAKI_P1 },
        { 67, xi.item.NONE       },
    }

    local loottwo =
    {
        { 80, xi.item.VIAL_OF_THE_TUMULT_CURATORS_BLOOD },
