...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.MEPHITASS_RING    },
        {  1, xi.item.MEPHITASS_RING_P1 },
        { 10, xi.item.TERNION_DAGGER    },
        {  1, xi.item.TERNION_DAGGER_P1 },
        { 78, xi.item.NONE              },
    }

    local loottwo =
    {
        { 80, xi.item.MEPHITASS_CLAW        },
