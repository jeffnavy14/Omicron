...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.SAILFI_BELT        },
        {  1, xi.item.SAILFI_BELT_P1     },
        { 10, xi.item.AUGURY_CUISSES     },
        {  1, xi.item.AUGURY_CUISSES_P1  },
        { 78, xi.item.NONE               },
    }

    local loottwo =
    {
        { 80, xi.item.EMPEROR_ARTHROS_SHELL },
