...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.DAMANI_HORN    },
        {  1, xi.item.DAMANI_HORN_P1 },
        { 15, xi.item.MOUFLON_RING   },
        { 15, xi.item.ACIPAYAM_BELT  },
        { 59, xi.item.NONE           },
    }

    local loottwo =
    {
        { 80, xi.item.STRAND_OF_SLEEPY_MABELS_FUR },
