...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.GHASTLY_TATHLUM },
        {  1, xi.item.GHASTLY_TATHLUM_P1 },
        { 10, xi.item.KLADENETS },
        {  1, xi.item.KLADENETS_P1 },
        { 78, xi.item.NONE       },
    }

    local loottwo =
    {
        { 80, xi.item.CHUNK_OF_SPECTERS_ORE },
