-----------------------------------
-- ID: 6315
-- Item: ironhorn_baldurnos_coffer
-----------------------------------
...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.THORFINN_SHIELD    },
        {  1, xi.item.THORFINN_SHIELD_P1 },
        { 15, xi.item.GRIT_EARRING       },
        { 15, xi.item.BLEATING_MANTLE    },
        { 64, xi.item.NONE               },
    }

    local loottwo =
    {
        { 80, xi.item.IRONHORN_BALDURNOS_HORN },
