-----------------------------------
-- ID: 6385
-- Item: vermillion_fishflys_coffer
-----------------------------------
...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.BLISTERING_SALLET },
        {  1, xi.item.BLISTERING_SALLET_P1 },
        { 10, xi.item.CACOETHIC_RING },
        {  1, xi.item.CACOETHIC_RING_P1 },
        { 78, xi.item.NONE       },
    }

    local loottwo =
    {
        { 80, xi.item.VERMILLION_FISHFLYS_WING },
