...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.LOXOTIC_MACE },
        {  1, xi.item.LOXOTIC_MACE_P1 },
        { 10, xi.item.SEETHING_BOMBLET },
        {  1, xi.item.SEETHING_BOMBLET_P1 },
        { 78, xi.item.NONE       },
    }

    local loottwo =
    {
        { 80, xi.item.PINCH_OF_GRAND_GRENADES_ASH },
