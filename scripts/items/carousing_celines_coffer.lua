...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.GAZU_BRACELETS },
        {  1, xi.item.GAZU_BRACELETS_P1 },
        { 10, xi.item.ODNOWA_EARRING },
        {  1, xi.item.ODNOWA_EARRING_P1 },
        { 78, xi.item.NONE       },
    }

    local loottwo =
    {
        { 80, xi.item.CAROUSING_CELINES_VINE },
