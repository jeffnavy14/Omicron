...
itemObject.onItemUse = function(target, user, item, action)
    ...
    {
        { 10, xi.item.BEHEADER },
        { 1, xi.item.BEHEADER_P1 },
        { 10, xi.item.DELIVERANCE },
        {  1, xi.item.DELIVERANCE_P1 },
        { 10, xi.item.FISTS_OF_FURY },
        {  1, xi.item.FISTS_OF_FURY_P1 },
        { 10, xi.item.PALOMA_BOW },
        {  1, xi.item.PALOMA_BOW_P1 },
        { 56, xi.item.NONE       },
    }

    local loottwo =
    {
        { 80, xi.item.STICK_OF_ETHEREAL_INCENSE },
