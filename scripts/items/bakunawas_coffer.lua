...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.BATHY_CHOKER },
        {  1, xi.item.BATHY_CHOKER_P1 },
        { 10, xi.item.DEMERSAL_DEGEN },
        {  1, xi.item.DEMERSAL_DEGEN_P1 },
        { 78, xi.item.NONE       },
    }

    local loottwo =
    {
        { 80, xi.item.VIAL_OF_BAKUNAWAS_INK },
