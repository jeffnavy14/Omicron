...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.HABILITATOR },
        {  1, xi.item.HABILITATOR_P1 },
        { 10, xi.item.TATENASHI_SUNE_ATE },
        {  1, xi.item.TATENASHI_SUNE_ATE_P1 },
        { 10, xi.item.VIM_TORQUE },
        {  1, xi.item.VIM_TORQUE_P1 },
        {  5, xi.item.TUMULT_CURATORS_COFFER },
        { 62, xi.item.NONE       },
    }

    local loottwo =
    {
        { 80, xi.item.THUBANS_SCALE },
