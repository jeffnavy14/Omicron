...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.APEILE_RING    },
        {  1, xi.item.APEILE_RING_P1 },
        { 10, xi.item.HIPPOMENES_SOCKS },
        {  1, xi.item.HIPPOMENES_SOCKS_P1 },
        { 78, xi.item.NONE           },
    }

    local loottwo =
    {
        { 80, xi.item.IMMANIBUGARDS_HIDE    },
