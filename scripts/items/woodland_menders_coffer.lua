...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.ROSETTE_JASERAN    },
        {  1, xi.item.ROSETTE_JASERAN_P1 },
        { 10, xi.item.POUWHENUA         },
        {  1, xi.item.POUWHENUA_P1      },
        { 78, xi.item.NONE              },
    }

    local loottwo =
    {
        { 80, xi.item.WOODLAND_MENDERS_LOG },
