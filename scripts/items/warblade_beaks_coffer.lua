...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.SHIGURE_TEKKO       },
        {  1, xi.item.SHIGURE_TEKKO_P1    },
        { 10, xi.item.HANDLERS_EARRING    },
        {  1, xi.item.HANDLERS_EARRING_P1 },
        { 78, xi.item.NONE                },
    }

    local loottwo =
    {
        { 80, xi.item.WARBLADE_BEAKS_HIDE   },
