-----------------------------------
-- ID: 6317
-- Item: valkurm_imperators_coffer
-----------------------------------
...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.IMPERIAL_WING_HAIRPIN    },
        {  1, xi.item.IMPERIAL_WING_HAIRPIN_P1 },
        { 10, xi.item.REGAL_PUMPS               },
        {  1, xi.item.REGAL_PUMPS_P1            },
        { 78, xi.item.NONE                      },
    }

    local loottwo =
    {
        { 80, xi.item.IMPERATORS_WING       },
