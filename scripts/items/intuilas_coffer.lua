...
itemObject.onItemUse = function(target, user, item, action)
    local lootone =
    {
        { 10, xi.item.ASSIDUITY_PANTS    },
        {  1, xi.item.ASSIDUITY_PANTS_P1 },
        { 10, xi.item.NOURISHING_EARRING },
        {  1, xi.item.NOURISHING_EARRING_P1 },
        { 78, xi.item.NONE               },
    }

    local loottwo =
    {
        { 80, xi.item.INTUILAS_HIDE         },
