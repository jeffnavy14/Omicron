...
zones[xi.zone.WAJAOM_WOODLANDS] =
{
    text =
    {
        ...
        WELLSPRING                    = 7461, -- The water in this spring is an unusual color...
        GIWAHB_WATCHTOWER_LOCKED      = 7998, -- The door is locked...
        INCREASED_STANDING            = 7999, -- Your Imperial Standing has increased!
        HEADY_FRAGRANCE               = 8503, -- The heady fragrance of wine pervades the air...
        BROKEN_SHARDS                 = 8505, -- Broken shards of insect wing are scattered all over...
        PAMAMA_PEELS                  = 8507, -- Piles of pamama peels litter the ground...
        DRAWS_NEAR                    = 8533, -- Something draws near!
        COMMON_SENSE_SURVIVAL         = 9651, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        UNITY_WANTED_BATTLE_INTERACT  = 9715, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
        CHIGOES =
