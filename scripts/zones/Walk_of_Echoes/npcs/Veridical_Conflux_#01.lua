...
xi.custom_htbf.configs[1] = {
            enabled = true,
            name = blackStar .. "Slimey Battle",
            meritCost = 1,
            mobName = "Slimey",
            spawnDynamic = function(zone)
                package.loaded["scripts/zones/Sacrarium/mobs/Slimey"] = nil
                local slimeyScript = require("scripts/zones/Sacrarium/mobs/Slimey")
                if slimeyScript and slimeyScript.spawn then
                    slimeyScript.spawn(zone)
                end
            end,
            teleport = { x = 219.6968, y = -2.0000, z = -0.8197, rot = 254, zoneId = xi.zone.SACRARIUM },
            clearRadius = 60,
            timeLimit = 30,
            remChapters = {
            ...
            difficulties = {
                { name = "Very Easy (Lvl: 113)",      mobLevel = 119, hppMod = 0, dropRateBonus = 0, statModMultiplier = 0.5, personalLoot = { remCount = 1, remItemCount = 1 } },
                { name = "Easy (Lvl: 116)",           mobLevel = 124, hppMod = 66.7, dropRateBonus = 10, statModMultiplier = 0.6, personalLoot = { remCount = 1, remItemCount = 1 } },
                { name = "Normal (Lvl: 119)",         mobLevel = 129, hppMod = 150, dropRateBonus = 20, statModMultiplier = 0.7, personalLoot = { remCount = 2, remItemCount = 1 } },
                { name = "Difficult (Lvl: 119+)",     mobLevel = 134, hppMod = 200, dropRateBonus = 40, statModMultiplier = 0.85, personalLoot = { remCount = 3, remItemCount = 1 } },
                { name = "Very Difficult (Lvl: ???)", mobLevel = 140, hppMod = 366.7, dropRateBonus = 90, statModMultiplier = 1.0, personalLoot = { remCount = 4, remItemCount = 1 } },
            },
            lootDelay = 10,
            loot = {
...
entity.onTrigger = function(player, npc)
    ...
    for configId, config in pairs(xi.custom_htbf.configs) do
        if configId == 1 and config and config.enabled then
