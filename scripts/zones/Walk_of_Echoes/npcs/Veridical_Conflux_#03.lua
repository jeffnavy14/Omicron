...
xi.custom_htbf.configs[3] = {
            enabled = true,
            name = blackStar .. "Absolute Virtue",
            meritCost = 15,
            mobName = "Absolute Virtue",
            spawnDynamic = function(zone)
                package.loaded["scripts/zones/Apollyon/mobs/Absolutevirtue"] = nil
                local avScript = require("scripts/zones/Apollyon/mobs/Absolutevirtue")
                if avScript and avScript.spawn then
                    avScript.spawn(zone)
                end
            end,
            teleport = { x = 1.2587, y = 0.000, z = -111.0148, rot = 64, zoneId = xi.zone.APOLLYON },
            clearRadius = 60,
            timeLimit = 30,
            remChapters = {
            ...
            mobMods = {
                { mod = xi.mod.STR, val = 400, target = true },
            ...
            difficulties = {
                --{ name = "Very Easy (Lvl: 113)",      mobLevel = 119, hppMod = 50, dropRateBonus = 0, statModMultiplier = 0.5, personalLoot = { remCount = 1, remItemCount = 0 }, lootIndex = 1 },
                --{ name = "Easy (Lvl: 116)",           mobLevel = 124, hppMod = 150, dropRateBonus = 0, statModMultiplier = 0.6, personalLoot = { remCount = 1, remItemCount = 1 }, lootIndex = 2 },
                { name = "Normal (Lvl: 119)",         mobLevel = 129, hppMod = 250, dropRateBonus = 0, statModMultiplier = 0.7, personalLoot = { remCount = 2, remItemCount = 1 }, lootIndex = 3 },
                { name = "Difficult (Lvl: 119+)",     mobLevel = 134, hppMod = 350, dropRateBonus = 0, statModMultiplier = 0.85, personalLoot = { remCount = 3, remItemCount = 1 }, lootIndex = 4 },
                { name = "Very Difficult (Lvl: ???)", mobLevel = 140, hppMod = 500, dropRateBonus = 0, statModMultiplier = 1.0, personalLoot = { remCount = 4, remItemCount = 1 }, lootIndex = 5 },
            },
            lootDelay = 10,
            loot = {
...
xi.custom_htbf.configs[4] = {
            enabled = true,
            name = blackStar .. "Proto-Omega",
            meritCost = 1,
            mobName = "Proto-Omega",
            spawnDynamic = function(zone)
                package.loaded["scripts/zones/Apollyon/mobs/Proto-Omega_HTBF"] = nil
                local omegaScript = require("scripts/zones/Apollyon/mobs/Proto-Omega_HTBF")
                if omegaScript and omegaScript.spawn then
                    omegaScript.spawn(zone)
                end
            end,
            teleport = { x = 1.2587, y = 0.000, z = -111.0148, rot = 64, zoneId = xi.zone.APOLLYON },
            clearRadius = 60,
            ...
            difficulties = {
                { name = "Very Easy (Lvl: 113)",      mobLevel = 119, hppMod = 1022, dropRateBonus = 0, statModMultiplier = 0.5, personalLoot = { remCount = 1, remItemCount = 0 } },
                { name = "Easy (Lvl: 116)",           mobLevel = 124, hppMod = 2057, dropRateBonus = 0, statModMultiplier = 0.6, personalLoot = { remCount = 1, remItemCount = 1 } },
                { name = "Normal (Lvl: 119)",         mobLevel = 129, hppMod = 2742, dropRateBonus = 0, statModMultiplier = 0.7, personalLoot = { remCount = 2, remItemCount = 1 } },
                { name = "Difficult (Lvl: 119+)",     mobLevel = 134, hppMod = 3771, dropRateBonus = 0, statModMultiplier = 0.85, personalLoot = { remCount = 3, remItemCount = 2 } },
                { name = "Very Difficult (Lvl: ???)", mobLevel = 140, hppMod = 5142, dropRateBonus = 0, statModMultiplier = 1.0, personalLoot = { remCount = 4, remItemCount = 2 } },
            },
            lootDelay = 10,
            loot = {
                -- Treasure pool loot goes here
...
xi.custom_htbf.configs[5] = {
            enabled = true,
            name = blackStar .. "Proto-Ultima",
            meritCost = 1,
            mobName = "Proto-Ultima",
            spawnDynamic = function(zone)
                package.loaded["scripts/zones/Apollyon/mobs/Proto-Ultima_HTBF"] = nil
                local ultimaScript = require("scripts/zones/Apollyon/mobs/Proto-Ultima_HTBF")
                if ultimaScript and ultimaScript.spawn then
                    ultimaScript.spawn(zone)
                end
            end,
            teleport = { x = 1.2587, y = 0.000, z = -111.0148, rot = 64, zoneId = xi.zone.APOLLYON },
            clearRadius = 60,
            ...
            difficulties = {
                { name = "Very Easy (Lvl: 113)",      mobLevel = 119, hppMod = 1046, dropRateBonus = 0, statModMultiplier = 0.5, personalLoot = { remCount = 1, remItemCount = 0 } },
                { name = "Easy (Lvl: 116)",           mobLevel = 124, hppMod = 2096, dropRateBonus = 0, statModMultiplier = 0.6, personalLoot = { remCount = 1, remItemCount = 1 } },
                { name = "Normal (Lvl: 119)",         mobLevel = 129, hppMod = 2797, dropRateBonus = 0, statModMultiplier = 0.7, personalLoot = { remCount = 2, remItemCount = 1 } },
                { name = "Difficult (Lvl: 119+)",     mobLevel = 134, hppMod = 3847, dropRateBonus = 0, statModMultiplier = 0.85, personalLoot = { remCount = 3, remItemCount = 2 } },
                { name = "Very Difficult (Lvl: ???)", mobLevel = 140, hppMod = 5248, dropRateBonus = 0, statModMultiplier = 1.0, personalLoot = { remCount = 4, remItemCount = 2 } },
            },
            lootDelay = 10,
            loot = {
                -- Treasure pool loot goes here
...
local function checkConfrontation(lookupKey)
    ...
    if didWin or didLose then
        ...
        if destZone then
            for _, mEntity in pairs(destZone:getMobs()) do
                local effect = mEntity:getStatusEffect(xi.effect.CONFRONTATION)
                if effect and effect:getPower() == lookupKey then
                    mEntity:delStatusEffect(xi.effect.CONFRONTATION)
                end
            end
        end
