...
xi.custom_htbf.configs[2] = {
            enabled = true,
            name = blackStar .. "Dark Ixion",
            meritCost = 1,
            mobName = "Dark_Ixion",
            spawnDynamic = function(zone)
                package.loaded["scripts/zones/Reisenjima_Sanctorium/mobs/darkixion"] = nil
                local ixionScript = require("scripts/zones/Reisenjima_Sanctorium/mobs/darkixion")
                if ixionScript and ixionScript.spawn then
                    ixionScript.spawn(zone)
                end
            end,
            teleport = { x = -0.1803, y = 4.0000, z = -10.9152, rot = 192, zoneId = xi.zone.REISENJIMA_SANCTORIUM },
            clearRadius = 60,
            timeLimit = 30,
            remChapters = {
            ...
            difficulties = {
                { name = "Very Easy (Lvl: 113)",      mobLevel = 119, hppMod = 75, dropRateBonus = 0, statModMultiplier = 0.5, personalLoot = { remCount = 1, remItemCount = 0 } },
                { name = "Easy (Lvl: 116)",           mobLevel = 124, hppMod = 125, dropRateBonus = 10, statModMultiplier = 0.6, personalLoot = { remCount = 1, remItemCount = 1 } },
                { name = "Normal (Lvl: 119)",         mobLevel = 129, hppMod = 250, dropRateBonus = 20, statModMultiplier = 0.7, personalLoot = { remCount = 2, remItemCount = 1 } },
                { name = "Difficult (Lvl: 119+)",     mobLevel = 134, hppMod = 400, dropRateBonus = 40, statModMultiplier = 0.85, personalLoot = { remCount = 3, remItemCount = 2 } },
                { name = "Very Difficult (Lvl: ???)", mobLevel = 140, hppMod = 800, dropRateBonus = 90, statModMultiplier = 1.0, personalLoot = { remCount = 4, remItemCount = 2 } },
            },
            lootDelay = 10,
            loot = {
...
entity.onTrigger = function(player, npc)
    ...
    local menuOptions = {}
    for configId, config in pairs(xi.custom_htbf.configs) do
        if configId == 2 and config and config.enabled then
