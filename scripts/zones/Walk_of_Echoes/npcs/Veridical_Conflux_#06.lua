...
xi.custom_htbf.configs[9] = {
            enabled = true,
            name = blackStar .. "Ancient Vows",
            meritCost = 1,
            mobName = "Mammet",
            spawnDynamic = function(zone, confID, diffIndex)
                package.loaded["scripts/zones/Riverne-Site_B01/mobs/Ancient_Vows_HTBF"] = nil
                local avScript = require("scripts/zones/Riverne-Site_B01/mobs/Ancient_Vows_HTBF")
                if avScript and avScript.spawn then
                    avScript.spawn(zone, confID, diffIndex)
                end
            end,
            teleport = { x = 707.9464, y = -23.4701, z = 370.9507, rot = 156, zoneId = xi.zone.RIVERNE_SITE_B01 },
            clearRadius = 150,
            timeLimit = 30,
            remChapters = {
            ...
            difficulties = {
                { name = "Very Easy (Lvl: 113)",      mobLevel = 119, hppMod = 1000, dropRateBonus = 0, statModMultiplier = 0.5, personalLoot = { remCount = 1, remItemCount = 0 } },
                { name = "Easy (Lvl: 116)",           mobLevel = 124, hppMod = 1500, dropRateBonus = 10, statModMultiplier = 0.6, personalLoot = { remCount = 1, remItemCount = 1 } },
                { name = "Normal (Lvl: 119)",         mobLevel = 129, hppMod = 2000, dropRateBonus = 20, statModMultiplier = 0.7, personalLoot = { remCount = 2, remItemCount = 1 } },
                { name = "Difficult (Lvl: 119+)",     mobLevel = 134, hppMod = 2500, dropRateBonus = 40, statModMultiplier = 0.85, personalLoot = { remCount = 3, remItemCount = 2 } },
                { name = "Very Difficult (Lvl: ???)", mobLevel = 140, hppMod = 3000, dropRateBonus = 90, statModMultiplier = 1.0, personalLoot = { remCount = 4, remItemCount = 2 } },
            },
            lootDelay = 10,
            loot = {
