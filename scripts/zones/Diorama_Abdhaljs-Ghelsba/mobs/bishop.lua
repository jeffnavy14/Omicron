...
entity.onMobDespawn = function(mob)
	if mob:getID() == 16953470 and
		GetMobByID(16953462):isSpawned()
	then
	...
	if mob:getID() == 16953473 and
		GetMobByID(16953465):isSpawned()
	then
		mob:timer(2000, function(mob)
			DespawnMob(16953465)
			SpawnMob(16953473)
