...
local bastionItems =
{
    ...
    {
--  Sel      Item                                  Cost, 
    [ 1] = { xi.item.CREED_CUISSES,                300 },
    [ 2] = { xi.item.BALE_FLANCHARD,               300 },
    [ 3] = { xi.item.FERINE_QUIJOTES,              300 },
    [ 4] = { xi.item.AOIDOS_RHINGRAVE,             300 },
    [ 5] = { xi.item.SYLVAN_BRAGUES,               300 },
    [ 6] = { xi.item.DAYBREAK_SOUL,                200 },
    [ 7] = { xi.item.TWILIGHT_SOUL,                200 },
    [ 8] = { xi.item.MAGNUS_STONE_POUCH,           150 },
    },
    [itemType.TEMP] =
    {
--  Sel      Item                          Cost, Qty
