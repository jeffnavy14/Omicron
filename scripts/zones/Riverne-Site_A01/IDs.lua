...
zones[xi.zone.RIVERNE_SITE_A01] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7267, -- A glowing mist of ever-changing proportions floats before you...
        ...
        TIME_LIMIT_FOR_THIS_BATTLE_IS = 7545, -- The time limit for this battle is # minutes.
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7608, -- Entering the battlefield for [Ouryu Cometh/]!
        SD_VERY_SMALL                 = 7612, -- The spatial displacement is very small. If you only had some item that could make it bigger...
        SD_HAS_GROWN                  = 7613, -- The spatial displacement has grown.
        SPACE_SEEMS_DISTORTED         = 7614, -- The space around you seems oddly distorted and disrupted.
        MONUMENT                      = 7621, -- Something has been engraved on this stone, but the message is too difficult to make out.
        HOMEPOINT_SET                 = 7749, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 7807, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
