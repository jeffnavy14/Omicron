...
entity.onMobDeath = function(mob, player)
    ...
    SetServerVariable("[Spawned]", 0) 
     ...
     player:PrintToArea("Kyahahaha! You thought you beat me? Too bad! I’m Mimi the mimic!", xi.msg.channel.SHOUT, xi.msg.area.SYSTEM, "Mimi")
  end
end
