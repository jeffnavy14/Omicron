...
zones[xi.zone.BHAFLAU_THICKETS] =
{
    text =
    {
        ...
        WELLSPRING                    = 7663, -- The water in this spring is an unusual color...
        SHED_LEAVES                   = 7672, -- The ground is strewn with shed leaves...
        BLOOD_STAINS                  = 7674, -- The ground is smeared with bloodstains...
        DRAWS_NEAR                    = 7699, -- Something draws near!
