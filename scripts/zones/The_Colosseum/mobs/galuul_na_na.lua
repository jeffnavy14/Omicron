...
entity.onMobEngaged = function(mob, player, target)
	...
	GetMobByID(17068072):updateEnmity(target)
...
entity.onMobDeath = function(mob, player)
	player:PrintToPlayer("Gurfurry has slighly weakened...", xi.msg.channel.NS_SAY)
end
