...
zones[xi.zone.HALVUNG] =
{
    text =
    {
        ...
        BLUE_FLAMES                   = 7991, -- You can see blue flames flickering from a hole in the ground here...
        SICKLY_SWEET                  = 8043, -- A sickly sweet fragrance pervades the air...
        THIN_LAYER_OF_CINDER          = 8050, -- The ground is carpeted in a thin layer of cinder.
        DRAWS_NEAR                    = 8065, -- Something draws near!
        DULL_PIECE                    = 8066, -- A dull piece of metal lies on the ground. It appears to be a bracelet of sorts, but the layers of grime covering its surface render it wholly unwearable.
        LIFT_LEVER                    = 8069, -- You lift the lever with all your might!
        UNITY_WANTED_BATTLE_INTERACT  = 8108, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
