...
local bastionItems =
{
    ...
    {
--  Sel      Item                                  Cost, 
    [ 1] = { xi.item.RAVAGERS_CUISSES,             300 },
    [ 2] = { xi.item.TANTRA_HOSE,                  300 },
    [ 3] = { xi.item.ORISON_PANTALOONS,            300 },
    [ 4] = { xi.item.GOETIA_CHAUSSES,              300 },
    [ 5] = { xi.item.ESTOQUEURS_FUSEAU,            300 },
    [ 6] = { xi.item.RAIDERS_CULOTTES,             300 },
    [ 7] = { xi.item.TWILIGHT_SOUL,                200 },
    [ 8] = { xi.item.DAYBREAK_SOUL,                200 },
    [ 9] = { xi.item.MAGNUS_STONE_POUCH,           150 },
    },
    [itemType.TEMP] =
    {
--  Sel      Item                          Cost, Qty
