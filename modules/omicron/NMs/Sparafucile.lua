...
-----------------------------------
local m = Module:new("Double4")

m:addOverride("xi.zones.GM_Home.Zone.onInitialize", function(zone)
    super(zone)

    if GetServerVariable("[Double4]") > 1 then
