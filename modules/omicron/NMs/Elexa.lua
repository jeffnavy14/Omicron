...
-----------------------------------
local m = Module:new("Double6")

m:addOverride("xi.zones.GM_Home.Zone.onInitialize", function(zone)
    super(zone)

    if GetServerVariable("[Double6]") > 1 then
