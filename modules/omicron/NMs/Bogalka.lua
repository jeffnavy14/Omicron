...
-----------------------------------
local m = Module:new("Double3")

m:addOverride("xi.zones.GM_Home.Zone.onInitialize", function(zone)
    super(zone)

    if GetServerVariable("[Double3]") > 1 then
