...
-----------------------------------
local m = Module:new("Double8")

m:addOverride("xi.zones.GM_Home.Zone.onInitialize", function(zone)
    super(zone)

    if GetServerVariable("[Double8]") > 1 then
