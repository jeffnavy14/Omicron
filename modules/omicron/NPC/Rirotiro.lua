...
m:addOverride("xi.zones.Port_Windurst.Zone.onInitialize", function(zone)
    ...
    onTrade = function(player, npc, trade)
        ...
        elseif (trade:hasItemQty(15435,1) and trade:hasItemQty(15436,1) and trade:hasItemQty(15437,1) and trade:hasItemQty(15438,1)
        ...
        elseif (trade:hasItemQty(18617,1) and trade:hasItemQty(2858,2) and trade:hasItemQty(2859,1)) then
        		player:tradeComplete()
                player:messageSpecial(ID.text.ITEM_OBTAINED, 18603);
                player:addItem(18603)
        elseif (trade:hasItemQty(19162,1) and trade:hasItemQty(2858,3) and trade:hasItemQty(2859,1)) then
        		player:tradeComplete()
                player:messageSpecial(ID.text.ITEM_OBTAINED, 19159);
                player:addItem(19159)
        elseif (trade:hasItemQty(19307,1) and trade:hasItemQty(2858,2) and trade:hasItemQty(2859,1)) then
        		player:tradeComplete()
                player:messageSpecial(ID.text.ITEM_OBTAINED, 19304);
                player:addItem(19304)
        elseif (trade:hasItemQty(17767,1) and trade:hasItemQty(2858,2) and trade:hasItemQty(2859,2)) then
        		player:tradeComplete()
                player:messageSpecial(ID.text.ITEM_OBTAINED, 17765);
                player:addItem(17765)
        elseif (trade:hasItemQty(19128,1) and trade:hasItemQty(2858,1) and trade:hasItemQty(2859,2)) then
        		player:tradeComplete()
